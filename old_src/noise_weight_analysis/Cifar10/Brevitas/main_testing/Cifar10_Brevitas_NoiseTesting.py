...
ber_noise_plot_brevitas(perturbations, layer_names, ber_vals, model, device, test_quantized_loader, model_name)
ber_noise_plot_brevitas_multiple_layers(perturbations, layer_names, ber_vals, model, device, test_quantized_loader, model_name)
