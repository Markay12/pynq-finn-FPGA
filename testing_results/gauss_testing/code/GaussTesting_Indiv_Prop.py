...
Description: This file serves as the core codebase for conducting experiments involving
             ...
             Within this script, the impact of noise on individual convolutional layers and
             linear layers is tested extensively. The results are visualized through output line
...
Parameters:  Proportional, Gaussian Noise, Individual Layers
Date: 15 August 2023
"""
...
## Gaussian Noise
sigma_vector = np.linspace(0, 0.2, 15)
